...
lawsuit = Car("red", "Ferrari", "F8 Tributo", "Explosive 5.4L V8", "single turbo", "6 spoke", "orange alcantara", "Carbon cermaic brembo", "dual tips", "michelin all season 22inch", "regulars", "black plastic", "carbon fiber bucket seats", "air", "aluminium", 339)
lawsuit.increase_speed()
lawsuit.get_tyres()
lawsuit.set_name()